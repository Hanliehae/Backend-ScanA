from src.database.models import Attendance, Meeting, Class, Course, ClassStudent, User
from src.database.config import SessionLocal
from sqlalchemy.orm import joinedload


def get_attendance_history(student_id=None, course_id=None, semester=None, academic_year=None, class_id=None, status=None):
    db = SessionLocal()
    try:
